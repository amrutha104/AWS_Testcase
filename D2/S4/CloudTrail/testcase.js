...
const result = [
    { name: "CloudTrail created in the name 'EventTrail'", weightage: 0, status: false, error: '' },
...
async function validateCloudTrailConfiguration() {
    ...
    try {
        const getTrailParams = { Name: 'EventTrail' };
        ...
        if (trailData) {
            ...
            try {
                const getEventSelectorsParams = { TrailName: 'EventTrail' };
